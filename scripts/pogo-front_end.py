...
scan_topic = "/scarab41/scan"

odom_motor_csv = bag.message_by_topic(odom_motor_topic)
scan_csv = bag.message_by_topic(scan_topic)
...
#     scan_list = []
#     for i in range(962):
#         column_string = "ranges_"+str(i)
#         scan_list.append(row[column_string])
#     # pointcloud = laser_proj.projectLaser(scan_list)
